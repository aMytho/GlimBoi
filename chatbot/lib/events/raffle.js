 ...
 */
function checkRaffleStatus(GUI, chatActive) {
    var events = EventHandle.getCurrentEvents()
...
module.exports = {addUserRaffle, checkRaffleStatus, getRaffleUsers, startRaffle, stopRaffle}