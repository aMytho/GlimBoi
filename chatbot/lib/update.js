//Handles auto update using https://www.update.rocks Free, and works really well. Checks for update on start.
...
const AUTO_UPDATE_URL = 'https://api.update.rocks/update/github.com/aMytho/GlimBoi/stable/' + process.platform + '/' + APP_VERSION
