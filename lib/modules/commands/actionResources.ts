 ...
 */
async function searchForVariables(data: {message:string, activation?:string, user?:userName}) {
...
export {addVariable, ApiRequest, removeVariables, searchForVariables, getv}